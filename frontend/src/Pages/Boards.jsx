  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-4xl font-semibold tracking-tight text-gray-900 mb-2">My Boards</h2>
          <p className="text-gray-600">Your workspace at a glance</p>
        </div>
        ...
        <div className="flex items-center justify-center py-20">
          <button onClick={()=>setShowModal(true)}
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Get started by creating a new workspace</p>
          </button>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {boards.map((board) => (
            ...
            >
              ...
              <div className="pr-8">
                <h3 className="text-lg font-semibold text-gray-900 mb-2 line-clamp-1">{board.title}</h3>
              </div>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center p-4 z-50 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scale-in">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Create new board</h2>
            <form onSubmit={handleCreateBoard} className="space-y-4">
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-150 outline-none" required autoFocus/>
              </div>
